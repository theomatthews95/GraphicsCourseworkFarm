...
public class Lab6 extends GraphicsLab
{
    ...
    private Texture currentSkyTextures;
    private String skyNightTextures;
    private String daySkyTextures;
    private String currentSkyTexture;
    private float firstFl= 0.6f;
    private float  secondFl = 0.6f;
    private float thirdFl = 0.6f;
    public static void main(String args[])
    {   new Lab6().run(WINDOWED,"Lab 6 - Animation",0.05f);
    }

    protected void initScene() throws Exception
    {
        skyNightTextures = "Lab6/textures/nightSky.bmp";
        daySkyTextures = "Lab6/textures/daySky.bmp";
        currentSkyTexture = skyNightTextures;

        currentSkyTextures = loadTexture(currentSkyTexture);
        // load the textures
    ...
    protected void checkSceneInput()
    {
        ...
        else if(Keyboard.isKeyDown(Keyboard.KEY_R) & isSun == true)
        {   risingSunMoon = true;
        turnONSunLight();
        }
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
            ...
            // enable texturing and bind an appropriate texture
            GL11.glEnable(GL11.GL_TEXTURE_2D);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D,currentSkyTextures.getTextureID());
        ...
        GL11.glPushMatrix();
        {
            ...
            float moonFrontSpecular[] = {firstFl, secondFl, thirdFl, 1.0f};
            float moonFrontDiffuse[]  = {firstFl, secondFl, thirdFl, 1.0f};
    ...
    private void turnOffMoonLight(){
    	float night[] = {0.001f, 0.001f, 0.001f, 1.0f}; 
    	GL11.glLight(GL11.GL_LIGHT0, GL11.GL_AMBIENT, FloatBuffer.wrap(night));
    }
    private void turnOnMoonLight(){
    	float MoonLight[] = {0.05f, 0.05f, 0.05f, 1.0f}; 
    	GL11.glLight(GL11.GL_LIGHT0, GL11.GL_AMBIENT, FloatBuffer.wrap(MoonLight));
    }
    private void changeToSun(){
        ...
        currentSkyTexture = daySkyTextures;
        try {
			currentSkyTextures = loadTexture(currentSkyTexture);
		} catch (Exception e) {
    ...
    private void turnOffSunLight(){

    	float twighlight[] = {0.09f, 0.09f, 0.09f, 1.0f}; 
    	GL11.glLight(GL11.GL_LIGHT0, GL11.GL_AMBIENT, FloatBuffer.wrap(twighlight));
    }
    
    private void turnONSunLight(){
    	float twighlightDif[] = {0.5f, 0.5f, 0.5f, 1.0f};
        GL11.glLight(GL11.GL_LIGHT0, GL11.GL_DIFFUSE, FloatBuffer.wrap(twighlightDif));
    	float twighlightAmb[] = {0.5f, 0.5f, 0.5f, 1.0f}; 
    	GL11.glLight(GL11.GL_LIGHT0, GL11.GL_AMBIENT, FloatBuffer.wrap(twighlightAmb));
    }
